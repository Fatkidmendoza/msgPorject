...
public class UsersBean implements Serializable {
	...
	public void executeUpdate(String firstName, String lastName, String email, String phoneNumber, String userName,
		...
		try {
			...
			FacesMessage errorMessage = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Update Failed.",
					"The user was modified before, buy another person.");
			FacesContext.getCurrentInstance().addMessage(null, errorMessage);
		}
	...
	public boolean permissionCompanyAdministrator() {
		return userInSession().getType().equals(Constants.ADMIN);
	}

	public boolean permissionCompanyManager() {
		return userInSession().getType().equals(Constants.COMPANY_MANAGER);
	}

	public String companyNameOfUserInSession() {
		String companyName = userInSession().getCompanyName();
		userToInsert.setCompanyName(companyName);
		return companyName;
	}
