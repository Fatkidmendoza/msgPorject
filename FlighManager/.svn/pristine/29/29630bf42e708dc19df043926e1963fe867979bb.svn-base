...
public class FlightRepositoryBean extends BaseRepositoryBean<Flight, Long> implements FlightRepository {
	...
	public void physicalDelete(Flight flight) throws RepositoryException {
		...
		} catch (PersistenceException | RepositoryException | NullPointerException e) {
	...
	@Override
	public List<Flight> getFlightsBetweenTwoDates(Date startDate, Date endDate) throws RepositoryException {
		try {
